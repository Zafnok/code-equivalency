...
/// <summary>
/// A generated C# method over <c>(int a, int b, long c, long d, bool e, string s, int[] u, int[] v, List&lt;int&gt; l, decimal m)</c> returning
...
public sealed record OracleMethod(Type ReturnType, string Body)
{
    public string Render(string name) =>
        $"public static {Keyword(ReturnType)} {name}(int a, int b, long c, long d, bool e, string s, int[] u, int[] v, System.Collections.Generic.List<int> l, decimal m)\n{{\n    int x = a; long y = c; bool z = e;\n{Body}}}\n";
