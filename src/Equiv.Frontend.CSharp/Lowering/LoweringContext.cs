...
/// <c>finally</c> (ticket M2-004's <c>Copy</c>, now <see cref="ExceptionLowerer.Copy"/>). Each region
...
internal sealed class LoweringContext(Dictionary<int, IrBlockId> blockIds, Dictionary<int, IrBlockId> mainBlocks, IrBlockId? handlerExit)
{
    ...
    /// <summary>Where a structured-exception-handling exit goes: null in the main pass, the continuation in a <c>finally</c> copy.</summary>
