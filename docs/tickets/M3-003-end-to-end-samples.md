# M3-003 end to end samples
Status: todo
Effort: M
Depends on: M2-004, M2-005, M2-006, M3-002

## Goal
All samples run through the CLI; verified SARIF snapshots checked in; exit codes asserted; README usage section written from real output.
