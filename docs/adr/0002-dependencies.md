...
| Microsoft.Z3 | 4.12.2 | Verify.Z3 | MIT (upstream Z3Prover/z3; not restored locally yet, confirm at M3-001) | official bindings, ships win/linux/osx natives. Package lags upstream (last push 2023) but the API is stable. Escape hatch: drop-in newer libz3 from GitHub releases |
