...
| 0035 | (proposed) The real runtimes are a second oracle: execution measures, confirms and bounds, and never proves |
| 0036 | (proposed) A proposed invariant, contract or table row is a hypothesis until a checker admits it; callee contracts replace unproven assumptions |
| 0037 | (proposed) An Unknown says whether the modern side can fail where the legacy side does not |
